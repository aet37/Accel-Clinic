	...
	def generate_pdf(self):
		...
		for i in range(len(self.accel_psds)):
			...
			if os.path.isfile(self.data_save_path + self.accel_trials[i] + '_ccw_spiral.csv'):
				...
				# Add the PSD figure in
				c.drawImage(ImageReader(self.data_save_path + 'analysis/pdf_figs/' + self.accel_psds[i] + '_ccw_spiral.png'), 50, height - 700, width=250, preserveAspectRatio=True, mask='auto')
